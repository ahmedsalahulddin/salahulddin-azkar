...
class DhikrReminder {
  ...
  /// The adhkar short enough to read at a glance on a lock screen. A long
  /// supplication truncated by the system is worse than not sending it.
  static List<Dhikr> get pool =>
      adhkar.where((d) => d.text.length <= 90).toList();
