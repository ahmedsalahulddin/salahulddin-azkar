...
import 'adhkar_translations/hi.dart';
import 'adhkar_translations/id.dart';
import 'adhkar_translations/ms.dart';
import 'adhkar_translations/tr.dart';
import 'adhkar_translations/ur.dart';

/// Machine translations of the daily adhkar, keyed by language then by
/// [Dhikr.id]. Unlike [Dhikr.english] — official where linked to Hisn
/// al-Muslim or a Quran ayah, hand-translated otherwise — these are Claude
/// AI renderings, not scholarly or human-reviewed. The UI discloses this
/// next to every one.
final Map<String, Map<String, String>> adhkarTranslations = {
  'bn': bnAdhkarTranslations,
  'fr': frAdhkarTranslations,
  'ha': haAdhkarTranslations,
  'hi': hiAdhkarTranslations,
  'id': idAdhkarTranslations,
  'ms': msAdhkarTranslations,
  'tr': trAdhkarTranslations,
  'ur': urAdhkarTranslations,
};

/// A dhikr's translation in [lang], or null if that language doesn't cover
/// this dhikr (or [lang] is 'en', which lives on [Dhikr.english] instead).
String? adhkarTranslationFor(String dhikrId, String lang) =>
    adhkarTranslations[lang]?[dhikrId];

/// Every available machine translation of one dhikr, keyed by language
/// code — what [DhikrText.moreTranslations] expects.
Map<String, String> adhkarTranslationsFor(String dhikrId) {
  final out = <String, String>{};
  for (final entry in adhkarTranslations.entries) {
    final text = entry.value[dhikrId];
...
class Dhikr {
  ...
  String? get audioUrl => audioId == null
      ? null
      : 'https://www.hisnmuslim.com/audio/ar/$audioId.mp3';
}
...
final List<AdhkarCategory> categories = [
  ...
  AdhkarCategory(
    ...
    icon: '🕌',
    description: 'تُقال بعد التسليم من الصلاة المفروضة',
  ),
  AdhkarCategory(
    id: 'sleep',
    name: 'أذكار النوم',
  ...
  AdhkarCategory(
    ...
    name: 'أذكار السفر',
    icon: '✈️',
    description: 'تُقال عند السفر وركوب الدابة',
  ),
  AdhkarCategory(
    id: 'ruqyah',
    name: 'الرقية الشرعية',
    icon: '📖',
    description: 'آيات وأدعية للرقية والتحصين',
  ),
  AdhkarCategory(
    id: 'deceased',
    name: 'الوفيات',
    icon: '🕊️',
    description: 'ادعُ لمن توفاهم الله بالرحمة والمغفرة',
  ),
];
...
final List<Dhikr> adhkar = const [
  ...
  Dhikr(
    ...
    repetitions: 1,
    benefit: 'سؤال الله العافية والحفظ من كل جانب',
    english:
        "O Allah, I ask You for pardon and well-being in this life and the next. O Allah, I ask You for pardon and well-being in my religion, my worldly affairs, my family and my wealth. O Allah, conceal my faults and calm my fears. O Allah, protect me from before me and behind me, from my right and my left, and from above me, and I take refuge in Your greatness from being struck down from beneath me.",
  ),
  Dhikr(
    id: 'morning-6',
    categoryId: 'morning',
  ...
  Dhikr(
    ...
    source: 'صحيح الترغيب',
    repetitions: 1,
    benefit: 'سؤال الله إصلاح جميع الشؤون',
    english:
  ...
  Dhikr(
    ...
    source: 'صحيح مسلم',
    repetitions: 3,
    benefit: 'يُقال بعد السلام مباشرة',
    english:
  ...
  Dhikr(
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'يُقال بعد الاستغفار ثلاثاً',
    english:
  ...
  Dhikr(
    ...
    source: 'صحيح البخاري',
    repetitions: 1,
    benefit: 'يُقال عند وضع الجنب للنوم',
  ...
  Dhikr(
    ...
    source: 'سنن أبي داود',
    repetitions: 1,
    benefit: 'كان النبي ﷺ يقولها إذا أراد أن ينام',
    english:
  ...
  Dhikr(
    ...
    source: 'صحيح البخاري',
    repetitions: 33,
    benefit: 'التسبيح قبل النوم - وصية النبي ﷺ لفاطمة وعلي',
    english: "(How perfect Allah is.)",
  ),
  Dhikr(
    id: 'sleep-4',
  ...
  Dhikr(
    ...
    categoryId: 'sleep',
    text:
        'اللَّهُمَّ رَبَّ السَّمَاوَاتِ السَّبْعِ وَرَبَّ الْأَرْضِ وَرَبَّ الْعَرْشِ الْعَظِيمِ، رَبَّنَا وَرَبَّ كُلِّ شَيْءٍ، فَالِقَ الْحَبِّ وَالنَّوَى، وَمُنْزِلَ التَّوْرَاةِ وَالْإِنْجِيلِ وَالْفُرْقَانِ، أَعُوذُ بِكَ مِنْ شَرِّ كُلِّ شَيْءٍ أَنْتَ آخِذٌ بِنَاصِيَتِهِ.',
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'التحصين الشامل قبل النوم',
    english:
        "O Allah, Lord of the seven heavens and Lord of the mighty Throne, our Lord and the Lord of all things, Splitter of the seed and the date-stone, Revealer of the Torah, the Gospel and the Criterion, I take refuge in You from the evil of everything whose forelock You hold.",
  ),
  ...
  Dhikr(
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'دعاء ركوب الدابة والسيارة',
    english:
        "Allah is the greatest, Allah is the greatest, Allah is the greatest. Glory is to Him who has subjected this to us, and we could never have accomplished it by ourselves, and indeed to our Lord we will return.",
  ),
  Dhikr(
    id: 'travel-2',
    categoryId: 'travel',
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'دعاء السفر الشامل',
    english:
        "O Allah, we ask You on this journey of ours for righteousness and piety, and for deeds that please You. O Allah, ease this journey for us and make its distance easy to cover. O Allah, You are our Companion on the road and the Guardian of our family.",
  ),
  Dhikr(
    id: 'travel-3',
    categoryId: 'travel',
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'الاستعاذة من مشقة السفر',
    english:
        "O Allah, I take refuge in You from the hardship of travel, from the sorrow of returning to find things amiss, and from an ill-fated return concerning wealth and family.",
  ),
  ...
  Dhikr(
    ...
    source: 'سورة الفلق',
    repetitions: 3,
    benefit: 'الاستعاذة من شرور المخلوقات',
    english:
  ...
  Dhikr(
    ...
    english:
        "I seek refuge in the perfect words of Allah from every devil and every poisonous creature, and from every evil, harmful eye.",
  ),
  Dhikr(
    id: 'ruqyah-6',
    categoryId: 'ruqyah',
  ...
  Dhikr(
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'من أعظم أدعية الجنازة — دعاء النبي ﷺ',
    english:
        "O Allah, forgive him, have mercy on him, grant him strength and pardon him. Honor his resting place and make spacious his entrance. Wash him with water, snow and hail, and cleanse him of sin as a white garment is cleansed of dirt.",
  ),
  Dhikr(
    id: 'deceased-2',
    categoryId: 'deceased',
    ...
    source: 'سنن الترمذي',
    repetitions: 1,
    benefit: 'دعاء شامل للأحياء والأموات',
    english:
        "O Allah, forgive our living and our dead, those present and those absent, our young and our old, our males and our females. O Allah, whoever You keep alive among us, keep him alive upon Islam, and whoever You cause to die among us, cause him to die upon faith.",
  ),
  Dhikr(
    id: 'deceased-3',
    categoryId: 'deceased',
    ...
    source: 'سنن أبي داود',
    repetitions: 1,
    benefit: 'يُذكر اسم المتوفى بدل "فلان بن فلان"',
    english:
        "O Allah, so-and-so, son of so-and-so, is under Your protection and in the shelter of Your care, so protect him from the trial of the grave and the punishment of the Fire. You are faithful to Your covenant and worthy of praise; forgive him and have mercy on him, for You are the Forgiving, the Merciful.",
  ),
  Dhikr(
    id: 'deceased-4',
    categoryId: 'deceased',
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'سؤال الله أن يبدله خيراً في الآخرة',
    english:
        "O Allah, give him an abode better than his home, and a family better than his family. Admit him into Paradise, and protect him from the punishment of the grave and the torment of the Fire.",
  ),
  Dhikr(
    id: 'deceased-5',
    categoryId: 'deceased',
    ...
    source: 'صحيح مسلم',
    repetitions: 1,
    benefit: 'طلب الأجر والثبات بعد فقد الميت',
    english:
        "O Allah, do not deprive us of his reward, and do not let us go astray after him, and forgive us and him.",
  ),
  Dhikr(
    id: 'deceased-6',
    categoryId: 'deceased',
    text: 'اللَّهُمَّ ثَبِّتْهُ عِنْدَ السُّؤَالِ.',
    source: 'رواه أبو داود',
    repetitions: 3,
    benefit:
        'كان النبي ﷺ يقف على القبر بعد الدفن ويقول: استغفروا لأخيكم وسلوا له التثبيت',
    english: "O Allah, make him firm when he is questioned.",
  ),
];
